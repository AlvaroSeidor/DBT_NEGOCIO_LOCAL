...
{% set src_ref = source('bronze_coopecarn', 'COOPECARN_TARIFF_NUMBER') %}
...
src as (
    select
        ...
        {{ std_cast('"SUPPLEMENTARY_UNITS"', 'INTEGER') }}                     as SUPPLEMENTARY_UNITS,
        {{ std_cast('"SUPPLEMENTARY_UOM"', 'VARCHAR') }}                       as SUPPLEMENTARY_UOM,
