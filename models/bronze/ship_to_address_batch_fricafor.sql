...
src as (
    select
        ...
        NULL                                                                   as CONTACT_NO,
        NULL                                                                   as GENERICAL_TRANSPORT_COST,
        NULL                                                                   as LANGUAGE_CODE,
        NULL                                                                   as OBSERVACIONES_ENVIO,
        NULL                                                                   as LOAD_TIME,
        NULL                                                                   as LOAD_HR,
        NULL                                                                   as LOAD_PREVIOUS_DAY,
        NULL                                                                   as TRIP_NO,
        NULL                                                                   as SHIPMENT_ZONE_CODE,
        NULL                                                                   as RETENER_FACTURACION,
        NULL                                                                   as VAT_BUS_POSTING_GROUP,
        NULL                                                                   as ADDITIONAL_INFO,
        NULL                                                                   as SIN_RESTRICCION_IDIOMAS,
        ...
        NULL                                                                   as EMAIL,
        NULL                                                                   as GLN,
        NULL                                                                   as IDPGND_EXCLUDE_SIG_RATE,
        NULL                                                                   as VAT_REGISTRATION_NO,
        NULL                                                                   as GRUPO_IRPF,
        NULL                                                                   as CDIGO_IDIOMA,
        NULL                                                                   as NM_SERIE_FACTURA_VENTA_REGISTRADA,
        NULL                                                                   as NM_SERIE_ABONO_VENTA_REGISTRADA,
        NULL                                                                   as TASAPUNTOVERDE,
        NULL                                                                   as TIPO_DESADV,
        NULL                                                                   as DL_CLIENTEFINAL,
        NULL                                                                   as DL_NUMTIENDAS,
        NULL                                                                   as DL_NTIENDAS,
        NULL                                                                   as DL_GAMANEGOCIO,
        NULL                                                                   as IF_LC_ID,
        NULL                                                                   as IF_SYS_STATE,
        NULL                                                                   as IF_PAIS_COD_ISO_3,
        NULL                                                                   as IF_SYS_PROVINCE,
