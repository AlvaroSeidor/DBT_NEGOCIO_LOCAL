...
{% set src_ref = source('bronze_delisano', 'V_DL_ATTRIBUTES') %}
...
src as (
    select
        ...
        {{ std_cast('"TableName"', 'VARCHAR') }}                               as TABLENAME,
        {{ std_cast('"Code"', 'VARCHAR') }}                                    as CODE,
        {{ std_cast('"Description"', 'VARCHAR') }}                             as DESCRIPTION,
        {{ std_cast('"AttributeID"', 'INTEGER') }}                             as ATTRIBUTEID,
        {{ std_cast('"AttributeIfID"', 'VARCHAR') }}                           as ATTRIBUTEIFID,
        {{ std_cast('"AttributeName"', 'VARCHAR') }}                           as ATTRIBUTENAME,
        {{ std_cast('"AttributeValue"', 'VARCHAR') }}                          as ATTRIBUTEVALUE,
        {{ std_cast('"uom"', 'VARCHAR') }}                                     as UOM,
