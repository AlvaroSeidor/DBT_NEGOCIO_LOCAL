...
src as (
    select
        ...
        NULL                                                                   as IVA,
        NULL                                                                   as IRPF,
        NULL                                                                   as NO_PROVEEDOR,
        NULL                                                                   as FECHA_ULT_VOLCADO_TARIFA,
        NULL                                                                   as HORA_ULT_VOLCADO_TARIFA,
        NULL                                                                   as FECHA_TARIFA_VOLCADA,
        NULL                                                                   as BALANCE_COMISSION_ACCOUNT,
        NULL                                                                   as EXPENSES_COMISSION_ACCOUNT,
        NULL                                                                   as CALC_COMISION_X_FECHA_COBRO,
