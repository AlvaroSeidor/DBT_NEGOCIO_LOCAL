...
{% set src_ref = source('bronze_fricafor', 'FRICAFOR_ORDEN_PRODUCCION_TRANSF_') %}
...
src as (
    select
        ...
        {{ std_cast('"FORZAR_SALIDA_DE_OC"', 'INTEGER') }}                     as FORZAR_SALIDA_DE_OC,
        {{ std_cast('"TIPO_MEZCLA_LOTE"', 'INTEGER') }}                        as TIPO_MEZCLA_LOTE,
        {{ std_cast('"ACCION_SALIDA_OC"', 'INTEGER') }}                        as ACCION_SALIDA_OC,
        ...
        {{ std_cast('"AL_REGISTRAR_SALIDAS"', 'INTEGER') }}                    as AL_REGISTRAR_SALIDAS,
        {{ std_cast('"SOURCE_NO_"', 'VARCHAR') }}                              as SOURCE_NO,
        {{ std_cast('"SOURCE_TYPE"', 'INTEGER') }}                             as SOURCE_TYPE,
        ...
        {{ std_cast('"PERMITE_SELECCION_PL_ORIGEN"', 'INTEGER') }}             as PERMITE_SELECCION_PL_ORIGEN,
        {{ std_cast('"CIERRE_CAJAS_POR"', 'INTEGER') }}                        as CIERRE_CAJAS_POR,
        {{ std_cast('"CALCULO_FECHA_CAD_"', 'INTEGER') }}                      as CALCULO_FECHA_CAD,
        {{ std_cast('"CONTROL_SALIDAS_PLANTA"', 'INTEGER') }}                  as CONTROL_SALIDAS_PLANTA,
        {{ std_cast('"_MARGEN_SALI_RESPECTO_CONS_"', 'NUMBER(38,5)') }}        as MARGEN_SALI_RESPECTO_CONS,
        {{ std_cast('"CLASIF_COMERCIAL_PERMITIDA"', 'INTEGER') }}              as CLASIF_COMERCIAL_PERMITIDA,
